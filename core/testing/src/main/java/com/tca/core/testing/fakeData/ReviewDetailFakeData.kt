...
import com.tca.core.model.network.AuthorDetail
import com.tca.core.model.network.ReviewDetails

/**
 * Created by Tam Nguyen on 11/07/2024.
 */

val authorDetailFakeData =
    AuthorDetail(
        name = "Chris Sawin",
        username = "ChrisSawin",
...
val reviewDetailsFakeData =
    ReviewDetails(
        author = "The Movie Mob",
        content =
            "The Flash uses the vast catalog of DC history to create an experience that celebrates the past films, " +
