package com.tca.feature.detail.view
...
import com.tca.core.ui.dataTest.MovieDetailFakeDataPreviewUI
import com.tca.core.ui.dataTest.MovieDetailPreviewParameterProvider
import com.tca.feature.detail.R
    ...
    ConstraintLayout(
        ...
        Box(
            ...
            LoadImage(
                imageWith = null,
                imageHeight = 250,
                imageUrl = movieDetail.backdropPath?.convertImageURL(),
                onClick = {
                    navToMovieFfmpeg.invoke()
                }
            )
        ...
        Box(
            ...
            LoadImage(
                imageWith = 100,
                imageHeight = 150,
                imageUrl = movieDetail.posterPath?.convertImageURL()
            )
        }
        ...
        RatingBar(
            modifier =
            Modifier.constrainAs(ratingbarMovie) {
        ...
        Text(
            text = movieDetail.releaseDate.toString(),
            fontSize = 16.sp,
            modifier =
            Modifier.constrainAs(tvMovieDate) {
                top.linkTo(tvRatedNumber.bottom, 10.dp)
                start.linkTo(tvRatedNumber.start)
            },
        )

        val productCountries =
            movieDetail.productionCountries?.let {
        ...
        Text(
            ...
            modifier =
            Modifier.constrainAs(tvMovieName) {
...
fun PreviewMovieDetail(
    ...
    MovieDetailBody(
        movieDetail = movieDetailFakeDataPreviewUI.listDbMovieDetailFakeDataPreviewUI[0],
        {},
        {})
}
